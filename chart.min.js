 ...
 */
    ...
    class F {
        constructor(t) {
            ...
            let i;
            var n, o, s;
            "object" === e ? i = z(t) : "string" === e && (s = (n = t).length,
            "#" === n[0] && (4 === s || 5 === s ? o = {
                r: 255 & 17 * r[n[1]],
                g: 255 & 17 * r[n[2]],
                b: 255 & 17 * r[n[3]],
    ...
    function Be(t, e) {
        ...
        n && !("" + n).match(Le) && (console.warn('Invalid font style specified: "' + n + '"'),
        n = "");
        const o = {
    ...
    function ci(t, i, n) {
        ...
        return r.observe(s),
        function(t, e) {
            ai.size || window.addEventListener("resize", li),
            ai.set(t, e)
        }(t, a),
        r
    }
    function hi(t, e, i) {
        ...
        "resize" === e && function(t) {
            ai.delete(t),
            ai.size || window.removeEventListener("resize", li)
        }(t)
    }
    function di(t, i, n) {
        const o = t.canvas
    ...
    class wi {
        ...
        _createAnimations(t, e) {
            ...
            for (r = s.length - 1; r >= 0; --r) {
                ...
                d && d.duration ? (o[l] = h = new yi(d,t,l,c),
                n.push(h)) : t[l] = c
            }
            return n
        }
    ...
    class Ei {
        ...
        updateIndex(t) {
            this.index !== t && Ai(this._cachedMeta),
            this.index = t
        }
        linkScales() {
            const t = this
        ...
        updateRangeFromParsed(t, e, i, n) {
            ...
            s = Si(n, o, this._cachedMeta.index, {
                all: !0
            })),
            t.min = Math.min(t.min, s),
            t.max = Math.max(t.max, s)
    ...
    function Wi(t, e) {
        ...
        if (s > 0) {
            ...
            for (Ni(e, l, c, $(n) ? 0 : a - n, a),
            t = 0,
            i = s - 1; t < i; t++)
                Ni(e, l, c, o[t], o[t + 1]);
            return Ni(e, l, c, r, $(n) ? e.length : r + n),
            l
        }
        return Ni(e, l, c),
        l
    ...
    class qi extends zi {
        ...
        update(t, e, i) {
            ...
            o.display && (o.autoSkip || "auto" === o.source) && (n.ticks = Wi(n, n.ticks),
            n._labelSizes = null),
        ...
        fit() {
            ...
            if (a) {
                ...
                e.height = Yi(s) + a) : (e.height = t.maxHeight,
                e.width = Yi(s) + a),
    ...
    function sn(t, e, i, n) {
        ...
        r.add(n);
        let l = an(r, a, i, s || i);
        return null !== l && ((!ht(s) || s === i || (l = an(r, a, s, l),
        null !== l)) && Ki(Array.from(r), [""], o, s, (()=>function(t, e, i) {
    ...
    function fn(t, e="x") {
        ...
        !function(t, e, i) {
            ...
            for (let h = 0; h < n - 1; ++h)
                l = c,
                c = hn(t, h + 1),
                l && c && (At(e[h], 0, cn) ? i[h] = i[h + 1] = 0 : (o = i[h] / e[h],
                s = i[h + 1] / e[h],
    ...
    function pn(t, e, i, n, o) {
        ...
        e.capBezierPoints && function(t, e) {
            ...
            n = t.length; i < n; ++i)
                ...
                r = i < n - 1 && Gt(t[i + 1], e),
                s && (o = t[i],
                a && (o.cp1x = gn(o.cp1x, e.left, e.right),
                o.cp1y = gn(o.cp1y, e.top, e.bottom)),
                r && (o.cp2x = gn(o.cp2x, e.left, e.right),
    ...
    function Qn(t) {
        return Zn() && "string" == typeof t ? t = document.getElementById(t) : t && t.length && (t = t[0]),
    ...
    class eo {
        ...
        _resize(t, e) {
            ...
            ve(i, r, !0) && (i.notifyPlugins("resize", {
                size: a
            }),
            Q(n.onResize, [i, a], i),
        ...
        buildOrUpdateScales() {
            ...
            J(s, (i=>{
                const s = i.options
                  ...
                  , r = Fn(a, s)
                  , l = K(s.type, i.dtype);
                void 0 !== s.position && Xn(s.position, r) === Xn(i.dposition) || (s.position = i.dposition),
                o[a] = !0;
                let c = null;
    ...
    class uo extends Ei {
        ...
        updateElements(t, e, i, n) {
            ...
            for (let h = e; h < e + i; h++) {
                ...
                u && (p.options = d || o.resolveDataElementOptions(h, t[h].active ? "active" : n)),
    ...
    function Vo(t) {
        ...
        const i = {};
        return e ? (e = t.horizontal ? Wo(e, "left", "right", t.base > t.x) : Wo(e, "bottom", "top", t.base < t.y),
        i[e] = !0,
        i) : i
    }
    function Wo(t, e, i, n) {
        var o, s, a;
        return n ? (a = i,
        t = No(t = (o = t) === (s = e) ? a : o === a ? s : o, i, e)) : t = No(t, e, i),
        t
    }
    function No(t, e, i) {
    ...
    var gs = {
        ...
        afterDatasetsUpdate(t, e, i) {
            ...
            for (a = 0; a < n; ++a)
                l = o[a],
                l && !1 !== l.fill && (l.fill = as(o, a, i.propagate))
        },
        beforeDraw(t, e, i) {
        ...
        adjustHitBoxes() {
            ...
            if (this.isHorizontal()) {
                ...
                for (const a of i)
                    ...
                    l += a.width + s;
                if (a) {
                    const e = i.reduce(((t,e)=>(t[e.row] = t[e.row] || [],
                    t[e.row].push(e),
                    t)), {})
                      , n = [];
    ...
    class Vs extends qi {
        ...
        buildTicks() {
            ...
            const o = function(t, e) {
                ...
                v < s && P++,
                At(Math.round((v + P * k) * y) / y, s, Bs(s, _, t)) && P++) : v < s && P++); P < M; ++P)
                    i.push({
    ...
    class sa extends qi {
        ...
        _generate() {
            ...
            u++)
                na(h, d, g);
            return d !== n && "ticks" !== o.bounds && 1 !== u || na(h, d, g),
    ...
    return eo.register(yo, la, Xo, zs),
    eo.helpers = {
        ...Tn
    },
    eo._adapters = ao,
